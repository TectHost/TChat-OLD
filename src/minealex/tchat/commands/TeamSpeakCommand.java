...
public class TeamSpeakCommand implements CommandExecutor {
    ...
    public TeamSpeakCommand(JavaPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (messagesFile.exists()) {
            ...
            if (config.contains("Rules")) {
                ...
                List<String> rulesList = config.getStringList("TeamSpeak");
                ...
                sender.sendMessage("Section 'TeamSpeak' not found in 'messages.yml'.");
            }
        } else {
