...
public class FacebookCommand implements CommandExecutor {
    ...
    public FacebookCommand(JavaPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (messagesFile.exists()) {
            ...
            if (config.contains("Facebook")) {
                ...
                List<String> rulesList = config.getStringList("Facebook");
                ...
                sender.sendMessage("Section 'Facebook' not found in 'messages.yml'.");
            }
        } else {
